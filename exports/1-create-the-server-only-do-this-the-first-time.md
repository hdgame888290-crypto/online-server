...
> **Kernel:** Python 3 | **Cells:** 2 code, 5 markdown | **Generated by:** [Jupy Tools](https://jupytools.com)

## Table of Contents

- [**1º Create the Server (Only do this the first time)**](#-1-create-the-server-only-do-this-the-first-time-)
- [**-> Start the Minecraft server - Use this whenever you want to open it.**](#-start-the-minecraft-server-use-this-whenever-you-want-to-open-it-)
